      ...
      <div className="h-[80vh] w-[80vw] bg-white border-2 border-white text-opacity-90 shadow-2xl md:w-[90vw] lg:w-[70vw] xl:w-[60vw] rounded-3xl grid xl:grid-cols-2">
        ...
        <div className="flex flex-col gap-10 items-center justify-center text-center">
          <div className='flex items-center justify-center flex-col'>
            ...
            <p className="font-medium w-full mt-4">Fill in the details to get started with the best chat app</p>
          </div>
          ...
          <Tabs defaultValue="account" className="w-3/4">
            ...
            <TabsContent value="login" id="login-content" className="flex flex-col gap-5 mt-10">
                <Input placeholder="Email" type="email" className="rounded-full p-6" value={email} onChange={e =>setEmail(e.target.value)}/>
                <Input placeholder="Password" type="password" className="rounded-full p-6" value={password} onChange={e =>setPassword(e.target.value)}/>
                <Button className="rounded-full p-6" onClick={handleLogin}>Login</Button>
            </TabsContent>
            <TabsContent value="signup" id="signup-content" className="flex flex-col gap-5">
                <Input placeholder="Email" type="email" className="rounded-full p-6" value={email} onChange={e =>setEmail(e.target.value)}/>
                <Input placeholder="Password" type="password" className="rounded-full p-6" value={password} onChange={e =>setPassword(e.target.value)}/>
                <Input placeholder="Confirm Password" type="passowrd" className="rounded-full p-6" value={confirmPassword} onChange={e =>setconfirmPassword(e.target.value)}/>
